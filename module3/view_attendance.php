...
$stmt = $conn->prepare("SELECT a.AttendanceID, e.Title AS EventTitle, a.AttendanceTime, a.Location, a.AttendanceStatus FROM attendance a JOIN event e ON a.EventID = e.EventID WHERE a.UserID = ?");
